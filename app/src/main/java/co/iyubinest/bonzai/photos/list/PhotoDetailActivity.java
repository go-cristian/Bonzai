...
public class PhotoDetailActivity extends BaseActivity {
  ...
  public void showSaveImageError() {
    Snackbar.make(previewView, R.string.photo_detail_error, Snackbar.LENGTH_SHORT).show();
  }

  public void showSaveImageGreeting() {
    Snackbar.make(previewView, R.string.photo_detail_success, Snackbar.LENGTH_SHORT).show();
  }
